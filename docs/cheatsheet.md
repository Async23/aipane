...
| `Cmd+T` | new window |
| `Cmd+W` | kill pane; centered confirm when the last pane runs an AI Tool |
...
| `Cmd+0` | select 10; repeat within 700ms → 20 → 30… |
...
| `prefix 0` / `Cmd+0` | select 10; repeat within 700ms → 20 → 30… |
